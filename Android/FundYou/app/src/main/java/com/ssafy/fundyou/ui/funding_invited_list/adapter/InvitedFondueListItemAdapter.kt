...
class InvitedFondueListItemAdapter : ListAdapter<FundingParticipateListModel, InvitedFondueListItemAdapter.InvitedFondueItemHolder>(
    ...
    private lateinit var clickListener : (FundingParticipateListModel) -> Unit
    inner class InvitedFondueItemHolder(private val binding: ItemInvitedFondueListBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(item: FundingParticipateListModel){
    ...
    fun fundingItemClickListener(fundingItem: (FundingParticipateListModel) -> Unit){
