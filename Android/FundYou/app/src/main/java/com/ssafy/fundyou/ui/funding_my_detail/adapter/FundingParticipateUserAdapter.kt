...
import com.ssafy.fundyou.databinding.ItemFundingParticipateUserListBinding
...
class FundingParticipateUserAdapter : ListAdapter<FundingParticipateUserUiModel, FundingParticipateUserAdapter.FundingParticipateUserHolder>(
    ...
    inner class FundingParticipateUserHolder(private val binding : ItemFundingParticipateUserListBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ) = FundingParticipateUserHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.item_funding_participate_user_list, parent, false))
